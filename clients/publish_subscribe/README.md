...
The purpose of this simple client is to make even simpler to subscribe client-side JavaScript functions
to Scriptr.io channels and to publish message to them/
...
### handling errors 
- When attempting to subscribe a function to a non existing channel:
The function receives the following message:
```
